...
G4ThreeVector detPlacement;
 ...
 switch(LayoutOptions) { 
    case 1:{ 
    detPlacement = G4ThreeVector(.0*cm, -201*cm, 0.*cm);
    G4cout
      << G4endl
      << " Position (0,-201,0)cm"
      << G4endl;           
        break;} 
    case 2:{ 
    detPlacement = G4ThreeVector(.0*cm, -226*cm, 0.*cm);
    G4cout
      << G4endl
      << " Position (0,-226,0)cm"
      << G4endl;           
        break;}
    case 3:{ 
    detPlacement = G4ThreeVector(.0*cm, -307*cm, 0.*cm);
    G4cout
      << G4endl
      << " Position (0,-307,0)cm"
      << G4endl;           
        break;}  
    case 4:{ 
    detPlacement = G4ThreeVector(.0*cm, -151*cm, 0.*cm);
    G4cout
      << G4endl
      << " Position (0,-151,0)cm"
      << G4endl;           
